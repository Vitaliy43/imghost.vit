 <script type="text/javascript" src="<?php if(isset($THEME)){ echo $THEME; } ?>js/tags.js?v=<?php echo date ('h'); ?>"></script>
...
<div class="search">
		<form action="/search" onsubmit="find(this);return false;">
			<table>
				<tr>
					<td valign="top">
						<div class="label"><?php echo $lang_main['SEARCH']; ?>:</div>
							<div class="input"><input class="edit" type="text" placeholder="<?php echo $lang_main['EXAMPLE_SEARCH']; ?>" value="" name="object" id="object"/></div>
					</td>
...
</div><?php $mabilis_ttl=1545381219; $mabilis_last_modified=1450775623; //d:\server\www\archive\imghost.vit\templates\imghost\blocks\search.tpl ?>