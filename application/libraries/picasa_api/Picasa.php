...
require_once($BASEPATH.DIRECTORY_SEPARATOR.'application'.DIRECTORY_SEPARATOR.'config'.DIRECTORY_SEPARATOR.'constants.php');
define('PICASA_PATH',SITE_DIR.DIRECTORY_SEPARATOR.'application'.DIRECTORY_SEPARATOR.'libraries'.DIRECTORY_SEPARATOR.'picasa_api'.DIRECTORY_SEPARATOR);

require_once PICASA_PATH.'Picasa/Image.php';
require_once PICASA_PATH.'Picasa/ImageCollection.php';
require_once PICASA_PATH.'Picasa/Album.php';
require_once PICASA_PATH.'Picasa/Account.php';
require_once PICASA_PATH.'Picasa/Comment.php';
require_once PICASA_PATH.'Picasa/Tag.php';
require_once PICASA_PATH.'Picasa/Author.php';
require_once PICASA_PATH.'Picasa/Exception.php';
require_once PICASA_PATH.'Picasa/Logger.php';
require_once PICASA_PATH.'Picasa/Exception/CaptchaRequiredException.php';
require_once PICASA_PATH.'Picasa/Exception/UnauthorizedException.php';
require_once PICASA_PATH.'Picasa/Exception/BadRequestException.php';
require_once PICASA_PATH.'Picasa/Exception/FailedAuthorizationException.php';
require_once PICASA_PATH.'Picasa/Exception/FileNotFoundException.php';
require_once PICASA_PATH.'Picasa/Exception/InternalServerErrorException.php';
require_once PICASA_PATH.'Picasa/Exception/ConflictException.php';
require_once PICASA_PATH.'Picasa/Exception/InvalidUsernameOrPasswordException.php';
