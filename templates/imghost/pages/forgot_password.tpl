    ...
    <div class="drop-content">
        <div class="inside-padd">
            <div class="horizontal-form">
                ...
                {/if}
                <form  method="post" id="forgot_password_form" onsubmit="ImageCMSApi.formAction('/authapi/forgot_password', '#forgot_password_form', {literal}{drop: '.drop-forgot', callback: function(msg, status, form, DS) {
                                if (status) {
                    ...
                    <div class="frame-label">
                        ...
                        <div class="frame-form-field">
                            ...
                            <div>
                                ...
                                <a href="{site_url('register')}">{lang('Регистрация','corporate')}</a>
                            </div>
                        </div>
                    </div>
                    {form_csrf()}
