...
<img src="/{$THEME}/images/icon_edit.png" width="12" height="12"/>
  ...
  {/if}
<h3 style="margin-bottom:10px;" id="post_comment">{$language.ADD_COMMENT}</h3>
<form action="{site_url('add_comment')}" method="post" class="form" onsubmit="add_comment(this);return false;" id="comment_form">
	...
	<div id="container_submit" style="margin-top:10px;">
		<input type="submit" class="submit" value="{$language.WRITE_COMMENT}" />
	</div>
