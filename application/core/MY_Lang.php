...
class Language{
	...
	public static $default_file = 'main';
	public static $module = 'imghost';
	
	public static function load_language($file){
		$lang = self::$lang.'_'.strtoupper(self::$lang);
		$filename = SITE_DIR . DIRECTORY_SEPARATOR.'application'.DIRECTORY_SEPARATOR.'modules'.DIRECTORY_SEPARATOR.self::$module.DIRECTORY_SEPARATOR.'language'.DIRECTORY_SEPARATOR.$lang.DIRECTORY_SEPARATOR.$file . '.php';
		include_once($filename);
		$function_name = 'lang_'.$file;
		self::$message[$file] = call_user_func($function_name);
	}
	public static function item($key,$file=null){
		if(!$file)
			$file = self::$default_file;
		return self::$message[$file][$key];
	}
	public static function get_languages($file){
