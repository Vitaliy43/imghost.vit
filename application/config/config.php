...
//            $db['default']['username'] = 'imghost';
            $db['default']['username'] = 'root';
//            $db['default']['password'] = 'imghost.vit';
            $db['default']['password'] = '385818';
//            $db['default']['database'] = 'imghost_new';
            $db['default']['database'] = 'imghost_work';
...
$config['proxy_ips'] = '';
$config['vk_id'] = 4470169;
$config['vk_key'] = 'ElVFb9HKN4RQMZmvZSBA';

$config['fb_id'] = '1444543559142824';
$config['fb_key'] = '3008fc8973a1435b4b8fda33c296ea0e';

$config['ok_id'] = '1098385664';
$config['ok_key'] = 'CBAKAJHCEBABABABA';
$config['ok_private_key'] = ' 4976E1CC36B36A9612ECB447';

$config['pic_id'] = '61851992677-rkaj0vaj4hf50rvlcm2mon765e9l82dn.apps.googleusercontent.com';
$config['pic_key'] = 'xy8LH2TQYS5qaspBH5p3EmJ4';

$config['bitly_key'] = 'R_35220931dbf54ccb96fe4fb35dcca483';
$config['bitly_user'] = 'vitaliy43';
