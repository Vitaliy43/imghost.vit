...
$lang['Admin_address'] = 'Адрес администратора';

/**
 * Mail Test
 */
$lang['Check_email_sending'] = 'Проверка отправки почты.';
...
$lang['Admin_email'] = 'Емейл администратора';
...
$lang['Send_email_to_user'] = 'Отправлять письмо пользователю';
$lang['Send_email_to_admin'] = 'Отправлять письмо администратору';
$lang['Yes'] = 'Да';
$lang['No'] = 'Нет';
$lang['Template_description'] = 'Описание шаблона';
$lang['Email_template_editing'] = 'Редактирование шаблона письма';
 ...
 * list template
 */
$lang['Template_email_deleting'] = 'Удаление шаблона письма';
